...
public class disjoint {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // set data source
		System.out.println("\n=== Streaming with disjoint window \n");
    ...
    windows.writeAsText("hdfs://10.254.0.136:8020/C_Q1_disjoint.output").setParallelism(1);
    ...
    public void apply
      ...
      for (Tuple3<String, Long, Integer> in: input) {
        count++;
                ...
                //out.collect(new Tuple3<String, Long, Integer>(key, window.getStart(), count));
      if (count > 100)
